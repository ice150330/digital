...
<style scoped>
.composer { display: flex; flex-direction: column; gap: var(--space-2); padding: var(--space-3); border: 1px solid var(--border-default); border-radius: var(--radius-lg); background: var(--bg-card); box-shadow: var(--shadow-xs); }
.composer-chips { display: flex; flex-wrap: wrap; gap: var(--space-2); }
.composer-chips button { min-height: 22px; padding: 0 var(--space-2); border: 1px solid var(--color-primary-100); border-radius: var(--radius-sm); background: var(--color-primary-50); color: var(--color-primary-700); cursor: pointer; font-size: var(--font-size-xs); }
...
.composer-row { display: flex; align-items: flex-end; gap: var(--space-2); }
.composer-row textarea { min-height: 64px; flex: 1; resize: vertical; padding: var(--space-2); border: 1px solid var(--border-default); border-radius: var(--radius-md); outline: 0; background: var(--bg-card); color: var(--text-body); font-size: var(--font-size-sm); line-height: 1.5; }
.composer-row textarea:focus { border-color: var(--border-focus); box-shadow: var(--ring-focus); }
