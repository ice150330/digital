...
.message-content { padding: var(--space-3); border: 1px solid var(--border-default); border-radius: var(--radius-lg); background: var(--bg-card); color: var(--text-body); font-size: var(--font-size-sm); line-height: 1.7; box-shadow: var(--shadow-xs); }
...
.contract-fold summary { display: flex; align-items: center; gap: var(--space-2); min-height: 32px; padding: 0 var(--space-3); color: var(--text-title); cursor: pointer; list-style: none; }
...
.contract-count { display: inline-flex; align-items: center; min-height: var(--tag-height-sm); padding: 0 var(--space-2); border-radius: var(--radius-sm); background: var(--bg-subtle); color: var(--text-secondary); font-size: var(--font-size-xs); white-space: nowrap; }
...
.contract-fold ul { margin: 0; padding: var(--space-2) var(--space-3) var(--space-2) var(--space-5); border-top: 1px solid var(--border-default); color: var(--text-body); font-size: var(--font-size-xs); line-height: 1.6; }
